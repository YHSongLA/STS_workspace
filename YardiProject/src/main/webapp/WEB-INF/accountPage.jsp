...
<body class="bg-secondary">
	...
	<div class="container mt-5 shadow p-3 mb-5 bg-body rounded">
		<div class="d-flex justify-content-between align-items-center">
			<div class="m-3 ms-5">
				<img src="#" alt="Profile Photo" /><br>
				<a href="/carts" class="btn btn-outline-warning mt-5 w-100">cart</a>
				<a href="/new/course" class="btn btn-outline-success mt-3 w-100">Add Course</a>
			</div>
			<!-- UPDATE USER PORTION -->
			<div class="border shadow p-3 rounded p-3 w-50 me-5">
				<h3 class="border-bottom p-1">Update Account</h3>
				<p>Username:</p>
				<p>First Name:</p>
				<p>Last Name:</p>
				<p>email:</p>
